...
This repository contains code for a Search Agent Learning Demo. The code demonstrates how to create and run an AI agent using OpenAI's tools and APIs.
...
```bash
git clone https://github.com/uzabumuhire/search-agent.git
cd search-agent
```
